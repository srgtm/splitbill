...
- распознавание количества, веса, модификаторов и построчных скидок;
- поддержка ресторанных и табличных продуктовых чеков с колонками «цена / скидка / количество / итог»;
- автоматическая сверка распознанной суммы с напечатанным итогом чека;
